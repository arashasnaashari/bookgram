...
const interval1 = () => {
  if (document.body.contains(document.querySelector("iframe"))) {
    ...
    btnSave.addEventListener("click", async (e) => {
      ...
      var npage = url.searchParams.get("page");
      if (book && userId) {
    ...
    for (let i = 0; i < iframes.length; i++) {
      ...
      let span = iframes[i].contentWindow.document.querySelectorAll("span");
      ...
      iframes[i].contentWindow.document.addEventListener("keyup", (e) => {
        if (e.key == "PrintScreen" || e.key == 44) {
          ...
          alert("اروررررررر اسکرین  !!");
        }
      });

      iframes[i].contentWindow.document.oncontextmenu = new Function(
        "return false;"
      );

      iframes[i].contentWindow.document.addEventListener("keydown", (e) => {
        if (e.shiftKey || e.key == "s" || e.key == "p") {
          //|| e.ctrlKey
          alert("ارووووووور");
          e.cancelBubble = true;
          e.preventDefault();
      ...
      btn.addEventListener("click", (e) => {
        ...
        if (!state2) {
          ...
          darkInterval = setInterval(() => {
            for (let i = 0; i < all.length; i++) {
              all[i].style.backgroundColor = "#121212";
              all[i].style.color = "#a5a5a5";
            }

            for (let i = 0; i < body.length; i++) {
              body[i].style.color = "#a5a5a5";
              body[i].style.userSelect = "none";
              body[i].style.borderColor = "gray";
            }
          }, 500);

          clearInterval(lightIntrval);

          state2 = "clicked";
          state4 = "clicked";
          clearInterval(intervalFirstColor);
        } else {
          lightIntrval = setInterval(() => {
            for (let i = 0; i < all.length; i++) {
              all[i].style.backgroundColor = "#f6efde";
            }
            for (let i = 0; i < body.length; i++) {
              body[i].style.color = "#2f180e";
              body[i].style.borderColor = "#2f180e";
      ...
      let intervalFirstColor = setInterval(() => {
        if (!state4) {
          for (let i = 0; i < span.length; i++) {
            span[i].style.lineHeight = "50px";
          }
          for (let i = 0; i < body.length; i++) {
            body[i].style.direction = "rtl";
            body[i].style.color = "#2f180e"; //%%
            body[i].style.fontFamily = "IranianSans";
            body[i].style.fontWeight = "900";
            // body[i].style.letterSpacing = "2px";
            body[i].style.wordSpacing = "10px";
            // body[i].style.lineHeight = "10px";
            body[i].style.WebkitUserSelect = "none"; // Safari
            body[i].style.msUserSelect = "none"; // IE 10 and IE11
            body[i].style.userSelect = "none"; // Standard syntax
          }
          for (let i = 0; i < pes.length; i++) {
            // pes[i].style.lineHeight = "10px";
            pes[i].style.userSelect = "none";
            pes[i].style.WebkitUserSelect = "none"; // Safari
            pes[i].style.msUserSelect = "none"; // IE 10 and IE11
            pes[i].style.userSelect = "none"; // Standard syntax
...
const timing = setInterval(interval1, 2000);
...
//       // change theme by click btn
//       if (all[i].style.backgroundColor === "#121212") {
//         document.body.style.filter = null;
