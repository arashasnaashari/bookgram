  ...
  11: function (e, t, n) {
    ...
    !(function (a, l) {
      "object" == i(t) && void 0 !== e
        ? (e.exports = l())
        : void 0 ===
            (o = "function" == typeof (r = l) ? r.call(t, n, t, e) : r) ||
          (e.exports = o);
    })(0, function () {
      "use strict";
      ...
      return (function e() {
        ...
        var te = K(Z, i),
          ...
          se = {};
        n.isSupported =
          oe && void 0 !== oe.createHTMLDocument && 9 !== l.documentMode;
        var ue = F,
          de = I,
          fe = j,
          pe = P,
          ...
          Ve = function (e) {
            (Be && Be === e) ||
              ((e && "object" === (void 0 === e ? "undefined" : B(e))) ||
                (e = {}),
              (he = "ALLOWED_TAGS" in e ? E({}, e.ALLOWED_TAGS) : ve),
              (be = "ALLOWED_ATTR" in e ? E({}, e.ALLOWED_ATTR) : Te),
              (Ge =
                "ADD_URI_SAFE_ATTR" in e ? E(M(We), e.ADD_URI_SAFE_ATTR) : We),
              (Pe =
                "ADD_DATA_URI_TAGS" in e ? E(M(Ue), e.ADD_DATA_URI_TAGS) : Ue),
              (Ae = "FORBID_TAGS" in e ? E({}, e.FORBID_TAGS) : {}),
              ...
              (Ne = e.RETURN_DOM_IMPORT || !1),
              (Ce = e.RETURN_TRUSTED_TYPE || !1),
              (De = e.FORCE_BODY || !1),
              (He = !1 !== e.SANITIZE_DOM),
              (ze = !1 !== e.KEEP_CONTENT),
              (Fe = e.IN_PLACE || !1),
              (ge = e.ALLOWED_URI_REGEXP || ge),
              Me && (_e = !1),
              we && (Re = !0),
              Ie &&
                ((he = E({}, [].concat(q(w)))),
                (be = []),
                !0 === Ie.html && (E(he, L), E(be, N)),
                !0 === Ie.svg && (E(he, k), E(be, C), E(be, z)),
                !0 === Ie.svgFilters && (E(he, D), E(be, C), E(be, z)),
                !0 === Ie.mathMl && (E(he, R), E(be, H), E(be, z))),
              e.ADD_TAGS && (he === ve && (he = M(he)), E(he, e.ADD_TAGS)),
              e.ADD_ATTR && (be === Te && (be = M(be)), E(be, e.ADD_ATTR)),
              e.ADD_URI_SAFE_ATTR && E(Ge, e.ADD_URI_SAFE_ATTR),
              ze && (he["#text"] = !0),
              Le && E(he, ["html", "head", "body"]),
              he.table && (E(he, ["tbody"]), delete Ae.tbody),
              o && o(e),
              (Be = e));
          },
          Ke = function (e) {
        ...
        var Xe = function (e) {
            return ie.call(
              e.ownerDocument || e,
              e,
              O.SHOW_ELEMENT | O.SHOW_COMMENT | O.SHOW_TEXT,
              function () {
          ...
          Qe = function (e) {
            return "object" === (void 0 === _ ? "undefined" : B(_))
              ? e instanceof _
              : e &&
                  "object" === (void 0 === e ? "undefined" : B(e)) &&
          ...
          et = function (e) {
            var t = void 0;
            if ((Ze("beforeSanitizeElements", e, null), Je(e)))
              return Ke(e), !0;
            var r = g(e.nodeName);
            if (
              (Ze("uponSanitizeElement", e, { tagName: r, allowedTags: he }),
              ("svg" === r || "math" === r) &&
            ...
            return ("noscript" === r && A(/<\/noscript/i, e.innerHTML)) ||
          ...
          tt = function (e, t, n) {
            if (He && ("id" === t || "name" === t) && (n in l || n in qe))
              return !1;
            if (_e && A(fe, t));
            else if (xe && A(pe, t));
            else {
          ...
          rt = function e(t) {
            ...
            for (Ze("beforeSanitizeShadowDOM", t, null); (n = r.nextNode()); )
              Ze("uponSanitizeShadowNode", n, null),
                et(n) || (n.content instanceof c && e(n.content), nt(n));
        ...
        return (
          (n.sanitize = function (e, r) {
            ...
            if (
              ...
              (1 ===
                (a = (o = $e("\x3c!--\x3e")).ownerDocument.importNode(e, !0))
                  .nodeType &&
                "BODY" === a.nodeName) ||
              "HTML" === a.nodeName
                ? (o = a)
              ...
              if (!Re && !Me && !Le && -1 === e.indexOf("<"))
                return te && Ce ? te.createHTML(e) : e;
              if (!(o = $e(e))) return Re ? null : ne;
            }
            o && De && Ke(o.firstChild);
            for (var d = Xe(Fe ? e : o); (l = d.nextNode()); )
              (3 === l.nodeType && l === s) ||
                et(l) ||
                (l.content instanceof c && rt(l.content), nt(l), (s = l));
            ...
            return (
              Me && ((f = v(f, ue, " ")), (f = v(f, de, " "))),
              te && Ce ? te.createHTML(f) : f
            );
          }),
      ...
      (O.sanitizeItemSource = function (e, t) {
        if (e && "string" == typeof e.Content && t && "string" == typeof t.As) {
          ...
          if (n)
            return (
              !(r = n.preprocess) || r(e),
              (e.Content = o.a.sanitize(e.Content, n.Options)),
              (function (t) {
                !t || t(e);
              })(n.postprocess),
              e.Content
        ...
        (O.sanitizeItemSource.Settings = {
          HTML: {
            ...
            postprocess: function (e) {
              return (e.Content = e.Content.replace(
                /(<head[\s>])/,
                "\n$1"
              ).replace(/(<\/body>)/, "$1\n"));
            },
